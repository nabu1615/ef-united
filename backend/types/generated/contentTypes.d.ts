...
export interface ApiMatchMatch extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    awayUser: Schema.Attribute.Relation<'oneToOne', 'api::person.person'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    homeScore: Schema.Attribute.Integer;
    homeUser: Schema.Attribute.Relation<'oneToOne', 'api::person.person'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::match.match'> &
      Schema.Attribute.Private;
    penals: Schema.Attribute.Enumeration<['home', 'away']>;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiMd3Md3 extends Struct.CollectionTypeSchema {
  collectionName: 'md_3s';
  info: {
    description: '';
    displayName: 'MD3';
    pluralName: 'md-3s';
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::md-3.md-3'> &
      Schema.Attribute.Private;
...
export interface ApiPersonPerson extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    md_3_s: Schema.Attribute.Relation<'oneToMany', 'api::md-3.md-3'>;
